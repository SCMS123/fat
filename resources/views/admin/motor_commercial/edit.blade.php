            ...
            <div class="col-lg-12"> 
              ...
              @endif
               ...
               <div class="card card-primary">
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form id="quickForm" action="{{route('motor_commercial.update')}}" method="POST" enctype="multipart/form-data" >
                     {{csrf_field()}}
                     ...
                     <div class="card-footer">
                        <div>
                           ...
                           <a href="{{route('motor_commercial.index')}}" class="btn btn-default btn-secondary">Back</a>
                        </div>
                     </div>
                  </form>
               </div> 

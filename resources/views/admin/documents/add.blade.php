         ...
         <div class="row">
            <div class="col-md-12">
               <div class="card card-primary">
                  ...
                  @endif
                  <form id="quickForm" action="{{route('documents.save')}}" method="POST" enctype="multipart/form-data">
                     {{csrf_field()}}
                     <div class="card-body">
                     ...
                     <div class="card-footer">
                        <div>
                           ...
                           <a href="{{route('documents.index')}}" class="btn btn-default btn-secondary">Back</a>
                        </div>
                     </div>
                  </form>
               </div>

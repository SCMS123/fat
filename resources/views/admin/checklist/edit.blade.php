              ...
              @endif
               ...
               <div class="card card-primary">
                  <div class="card-header">
                     <h3 class="card-title">Checklist Edit</h3>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form id="quickForm" role="form" action="{{ route('checklist.update') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                 {{csrf_field()}}
                     ...
                     <div class="card-body">
                        ...
                        <div class="form-group">
                           ...
                           <select name="policy_category_id"  id="policy_category_id" class="form-control">
                               ...
                               <option value="{{$policycat->id}}" @if($policycat->id == $result->policy_category_id ) selected @endif>{{$policycat->name}}</option>
                               @endforeach
                         ...
                         <div class="form-group">
                           ...
                           <select name="policy_sub_category_id"  id="policy_sub_category_id" class="form-control">
                               ...
                               <option value="{{$policysubcat->id}}" @if($policysubcat->id == $result->policy_sub_category_id ) selected @endif>{{$policysubcat->name}}</option>
                               @endforeach
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" name="title" class="form-control" id="title"  value="{{$result->title}}" placeholder="Enter Title" autocomplete="off" />
                        </div>

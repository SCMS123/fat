                     ...
                     <div class="card-body">
                        <div class="form-group">
                           ...
                           <select name="account_type" class="form-control">
                              ...
                              <option value="{{$account->id}}" @if($user->account_type == $account->id) selected @endif>{{$account->account_name}}</option>
                              @endforeach
                              </select>
                        </div>
                        ...
                        <div class="form-group">
                           <label for="branch_id">Branch</label>
                            <select name="branch_id" id="branch_id" class="form-control">
                              ...
                              <option value="{{$branch->id}}" @if($branch->id==$user->branch_id) selected @endif>{{$branch->branch_name}}</option>
                              @endforeach
                           </select>
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" name="mobile" class="form-control" id="mobile" value="{{$user->mobile}}" placeholder="Enter Phone" autocomplete="off" />
                        </div>
                        
                        <div class="form-group">
                           <label for="address">Address</label>
                           <textarea name="address" class="form-control" id="address" placeholder="Enter Address" autocomplete="off">{{$user->address}}</textarea>
                        ...
                        <div class="form-group">
                           <label for="bio">Bio</label>
                            ...
                            <textarea name="bio" class="form-control" id="bio" placeholder="Enter Bio" autocomplete="off">{{$user->bio}}</textarea>
                        </div>
                        <?php $i=0;?>

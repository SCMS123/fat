               ...
               <li class="nav-item <?php if(!empty($checkRoute) && $checkRoute->section_id == $section->id){echo 'menu-open';} ?>">
                  ...
                  @if(!empty($roles))
                     ...
                     if (Auth::user()->user_type == 'admin' || !empty($adminPermissions)) { ?>
                        ...
                        <ul class="nav nav-treeview">
                           <li class="nav-item">
                              <a href="{{ route($rol->url)}}" class="nav-link <?php if(!empty($checkRoute) && ($checkRoute->id == '32' || $checkRoute->id == '33' || $checkRoute->id == '34')){echo 'active';} ?>">
                                 <i class="fas fa-chevron-right"></i>
                                 <p>{{$rol->name}}</p>
                              </a>
                           </li>
                     ...
                     if (Auth::user()->user_type == 'admin' || !empty($adminPermissions)) { ?>
                        ...
                        <ul class="nav nav-treeview">
                           <li class="nav-item">
                              <a href="{{ route($rol->url)}}" class="nav-link <?php if(!empty($checkRoute) && ($checkRoute->id == '36')){echo 'active';} ?>">
                                 <i class="fas fa-chevron-right"></i>

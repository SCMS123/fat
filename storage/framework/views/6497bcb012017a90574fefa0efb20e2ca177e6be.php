            ...
            <div class="col-lg-12"> 
              ...
              <?php endif; ?>
               ...
               <div class="card card-primary">
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form id="quickForm" role="form" action="<?php echo e(route('sub_admin.add')); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fat\resources\views/admin/sub_admin/account_type.blade.php ENDPATH**/ ?>
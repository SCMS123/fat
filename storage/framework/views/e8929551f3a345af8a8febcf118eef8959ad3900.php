                     ...
                     <div class="card-body">
                        ...
                        <div class="form-group">
                           ...
                           <select name="account_type" id="account_type" class="form-control" disabled="disabled">
                              ...
                              <option value="<?php echo e($account->id); ?>" <?php if($account->id==$account_type): ?> selected <?php endif; ?>><?php echo e($account->account_name); ?></option>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                          ...
                                          <div class="form-group clearfix">
                                             ...
                                             <input type="hidden" name="role_id<?php echo e($i); ?>" value="<?php echo e($rol->id); ?>">
                                                ...
                                                foreach($action_id as $actid){
                                                   ...
                                                   <div class="d-inline">
                                                      <input type="checkbox" checked id="checkbox_<?php echo e($i); ?>" name="action_id<?php echo e($i); ?>[]" value="<?php echo e($actions->action_slug); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hm3hczr3zv0q/public_html/demo/fat/resources/views/admin/sub_admin/add.blade.php ENDPATH**/ ?>
...
<div class="content-wrapper">
   <div class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0 text-dark">Doument</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-md-12">
               <div class="card card-primary">
                  <div class="card-header">
                     <h3 class="card-title">Add <small>Document</small></h3>
                  </div>
                  ...
                  <?php endif; ?>
                  <form id="quickForm" action="<?php echo e(route('documents.save')); ?>" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="card-footer">
                        <div>
                           ...
                           <a href="<?php echo e(route('documents.index')); ?>" class="btn btn-default btn-secondary">Back</a>
                        </div>
                     </div>
                  </form>
               </div>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fat\resources\views/admin/documents/add.blade.php ENDPATH**/ ?>
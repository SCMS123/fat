...
<div class="content-wrapper"> 
   ...
   <div class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0 text-dark">Motor Commercial Insurance</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active">Motor Commercial Insurance Add</li>
               </ol>
            </div><!-- /.col -->
         </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <?php endif; ?>
               ...
               <div class="card card-primary">
                  <div class="card-header">
                     <h3 class="card-title">Motor Commercial Insurance Add</h3>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form id="quickForm" action="<?php echo e(route('motor_commercial.save')); ?>" method="POST" enctype="multipart/form-data" >
                        ...
                        <div class="row">
                           <div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="body_type" class="form-control" id="body_type" placeholder="Enter Type of Body" value="<?php echo e(old('body_type')); ?>" required>
                              </div>
                           </div>
                     ...
                     <div class="card-footer">
                        <div>
                           ...
                           <a href="<?php echo e(route('motor_commercial.index')); ?>" class="btn btn-default btn-secondary">Back</a>
                        </div>
                     </div>
                  </form>
               </div> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hm3hczr3zv0q/public_html/demo/fat/resources/views/admin/motor_commercial/add.blade.php ENDPATH**/ ?>
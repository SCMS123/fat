         ...
         <div class="row mb-2">
            ...
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Account Type Add</li>
               </ol>
            </div><!-- /.col -->
         </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <?php endif; ?>
               ...
               <div class="card card-primary">
                  <div class="card-header">
                     <h3 class="card-title">Account Type Add</h3>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form id="quickForm" role="form" action="<?php echo e(route('account_type.save')); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                 <?php echo e(csrf_field()); ?>
                     ...
                     <div class="card-body">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" name="account_name" class="form-control" id="account_name" placeholder="Enter Account Name" autocomplete="off" />
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hm3hczr3zv0q/public_html/demo/fat/resources/views/admin/account_type/add.blade.php ENDPATH**/ ?>
            ...
            <div class="col-lg-12"> 
              ...
              <?php endif; ?>
               ...
               <div class="card card-primary"> 
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form id="quickForm" role="form" action="<?php echo e(route('policy_sub_categories.update')); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                     ...
                     <div class="card-body">
                        <div class="form-group">
                           ...
                           <select name="category_id"  id="category_id" class="form-control">
                               ...
                               <option value="<?php echo e($category->id); ?>" <?php if($category->id==$result->category_id): ?> selected <?php endif; ?>><?php echo e($category->name); ?> </option>
                               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hm3hczr3zv0q/public_html/demo/fat/resources/views/admin/policysubcategories/edit.blade.php ENDPATH**/ ?>
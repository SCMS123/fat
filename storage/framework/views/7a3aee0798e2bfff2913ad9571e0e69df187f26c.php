            ...
            <div class="col-lg-12"> 
              ...
              <?php endif; ?>
               ...
               <div class="card card-primary">
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form id="quickForm" action="<?php echo e(route('motor_private.update')); ?>" method="POST" enctype="multipart/form-data" >
                     ...
                     <div class="card-body">
                        ...
                        <div class="row">
                           <div class="col-md-4">
                              <div class="form-group">
                                 <label>(a) Will the car be used EXCLUSIVELY 
                                 for social, domestic and pleasure 
                               purposes? </label>
                                 <input type="text" name="1a" class="form-control"   value="<?php echo e($result->onea); ?>">
                              </div>
                           </div>
                        ...
                        <div class="row">
                           <div class="col-md-4">
                              <div class="form-group">
                                 <label for="">(b) If not will the other use(s) be
                                 (i) Solely by you in person for your 
                               business or profession?</label>
                                 <input type="text" name="oneb1" class="form-control" value="<?php echo e($result->oneb1); ?>"  >
                              </div>
                           </div>
                          ...
                          <div class="col-md-4">
                              <div class="form-group">
                                 <label for="">
                                 (ii) On your business by your 
                                 employees or other persons?</label>
                                 <input type="text" name="oneb2" class="form-control" value="<?php echo e($result->oneb2); ?>"   >
                              </div>
                           </div>                           
                        ...
                        <div class="col-md-4">
                              <div class="form-group">
                                 <label for="">
                                 (iii) By any other person for your 
                                 business or profession?</label>
                                 <input type="text" name="oneb3" class="form-control" value="<?php echo e($result->oneb3); ?>"   >
                              </div>
                           </div>                           
                        ...
                        <div class="col-md-4">
                              <div class="form-group">
                                 <label>
                                 (iv) For the carriage of goods or 
                              samples in connection with your 
                             trade or business?</label>
                                 <input type="text" name="oneb4" class="form-control" value="<?php echo e($result->oneb4); ?>">
                              </div>
                           </div>                           
                        ...
                        <div class="col-md-4">
                              <div class="form-group">
                                 <label>
                                 (v) For the carriage of farm requisite 
                                  produce or livestock?</label>
                                 <input type="text" name="oneb5" class="form-control" value="<?php echo e($result->oneb5); ?>" >
                              </div>
                           </div>                           
                        ...
                        <div class="col-md-4">
                              <div class="form-group">
                                 <label>
                                 (vi) For commercial travelling?</label>
                                 <input type="text" name="oneb6" class="form-control" value="<?php echo e($result->oneb6); ?>">
                              </div>
                           </div>                           
                        ...
                        <div class="col-md-4">
                              <div class="form-group">
                                 <label>
                                 (vii)For the carriage of passengers 
                                 for hire or reward or will the car 
                                be let out on hire? </label>
                                 <input type="text" name="oneb7" class="form-control" value="<?php echo e($result->oneb7); ?>">
                              </div>
                           </div>                           
                        ...
                        <div class="col-md-4">
                              <div class="form-group">
                                 <label>
                                (viii) For any other purposes, if so </label>
                                 <input type="text" name="oneb8" class="form-control" value="<?php echo e($result->oneb8); ?>">
                              </div>
                           </div>                           
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hm3hczr3zv0q/public_html/demo/fat/resources/views/admin/motor_insurance/motor_private_edit.blade.php ENDPATH**/ ?>